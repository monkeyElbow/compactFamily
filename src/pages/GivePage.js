        ...
        <Container>
          <Row className="text-center">
            <Col lg={6} md={12} className="mt-3 d-flex align-items-center">
              <div>
                <h1 className="display-4">GIVE</h1>
      ...
      <Container fluid className="bg-blue text-white py-5 text-center">
        <Container>
          <h4 className="col-lg-6 col-md-12 text-center offset-lg-3 offset-md-0 mb-5">
            ...
            donors <strong>YOU</strong>, and where you desire to give are <strong>VERY</strong> important.
          </h4>
            ...
            <div className="card col-md-6 col-lg-3 col-sm-12 clickable bg-blue text-white border-white">
              <div className="card-body d-flex flex-column">
                ...
                <p className="card-text">
                  Our COMP<strong>ACT</strong> Partners help us care for these
                  vulnerable children and families by providing an open gift to
                  our ministry. These undesignated offerings allow us to use
                  your gift where it is most needed for our ministry.
                </p>
            ...
            <div className="card col-md-6 col-lg-3 col-sm-12 clickable bg-blue text-white border-white">
              <div className="card-body d-flex flex-column">
                ...
                <p className="card-text">
                  ...
                  <strong>ACT</strong> is through our monthly sponsorship
                  program. Becoming a sponsor allows you to build a relationship
                  with the cottage or child you give towards every month.
                </p>
